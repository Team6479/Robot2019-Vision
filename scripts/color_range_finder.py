...
cv2.createTrackbar(
    "high_h", "bitmask", 0, 360, lambda v: on_trackbar("high_h", v, low, high)
)
cv2.createTrackbar(
    "high_s", "bitmask", 0, smaller_max, lambda v: on_trackbar("high_s", v, low, high)
)
cv2.createTrackbar(
    "high_v", "bitmask", 0, smaller_max, lambda v: on_trackbar("high_v", v, low, high)
)
